...
public class RestProjectFileMpp {
    ...
    public static ProjectFile addFechasTareas(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException{
        SimpleDateFormat df = new SimpleDateFormat("E MMM dd HH:mm:ss zzz yyyy");
       
        project.getAllTasks().remove(project.getAllTasks().get(0));
        for(int i=0;i< ((JSONArray)(jsonObject.get("tareas"))).length();i++){
            try {
    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
       ...
       /* try {
            ...
            project.getAllTasks().get(0).setStart(df.parse(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("fechaInicio")));
            project.getAllTasks().get(0).setStartText(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("TfechaInicio"));
            project.getAllTasks().get(0).setActualStart(df.parse(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("AfechaInicio")));
            project.getAllTasks().get(0).setFinish(df.parse(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("fechaFin")));
            project.getAllTasks().get(0).setFinishText(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("TfechaFin"));
            project.getAllTasks().get(0).setActualFinish(df.parse(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("AfechaFin")));
