        ...
        for(int i=0 ;i< ((JSONArray)(jsonObject.get("asigRecursos"))).length();i++){
            try {
                ...
                if(json.getString("ActualWork").contains("d")){
                    ...
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("d", "")),TimeUnit.DAYS));
                    }
                    ...
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("h", "")),TimeUnit.HOURS));
                    }
                }
                    ...
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("y", "")),TimeUnit.YEARS));
                    }
                }
                    ...
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("w", "")),TimeUnit.WEEKS));
                    }
                }
                    ...
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("m", "")),TimeUnit.MINUTES));
                    }
                }
                else if(json.getString("ActualWork").contains("M")){
                    assignment.setActualWork(Duration.getInstance(Double.parseDouble(json.getString("ActualWork").replace("M", "")),TimeUnit.MONTHS));
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("M", "")),TimeUnit.MONTHS));
                    }
                }
                else{
                    assignment.setActualWork(Duration.getInstance(Double.parseDouble(json.getString("ActualWork").replace("p", "")),TimeUnit.PERCENT));
                    if(json.getString("UniqueID").compareToIgnoreCase("null")!=0){
                        assignment.setDelay(Duration.getInstance(Double.parseDouble(json.getString("UniqueID").replace("p", "")),TimeUnit.PERCENT));
                    }
                }
