...
public class RestProjectFileMpp {
    ...
    public String postJson(@RequestBody String payload) throws Exception{
        ...
        CustomFieldContainer fields = projectObj.getCustomFields();
        for (CustomField field :projectObj.getCustomFields())
        {
            ...
            CustomFieldValueItem item = new CustomFieldValueItem(8);
