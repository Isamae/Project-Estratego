    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
        ...
        for(int i=0;i< ((JSONArray)(jsonObject.get("tareas"))).length();i++){
            try {
                ...
                project.getTaskByID(json.getInt("id")).setFinish(json.getInt("id"));
                project.getTaskByID(json.getInt("id")).setActualFinish(json.getInt("id"));
                project.getTaskByID(json.getInt("id")).setFinishText(json.getInt("id"));
