                    ...
                    if(datoObject.getInt("FieldTypeID") == -1){}
                        ...
                        if(datoObject.getString("ValorCampo").compareToIgnoreCase("null") ==0){
                            ...
                            if(tipodato.compareToIgnoreCase("STRING")==0){
                                ...
                                //tarea.setPercentageWorkComplete(Double.parseDouble(datoObject.getString("ValorCampo")));
                                //tarea.setPercentageComplete(Double.parseDouble(datoObject.getString("ValorCampo")));
                                seteadoValue =  Integer.parseInt(datoObject.getString("ValorCampo")) ;
                            }
                            else{
