...
public class RestProjectFileMpp {
    ...
    public String postJson(@RequestBody String payload) throws Exception{
		...
		File file = ResourceUtils.getFile("classpath:"+"clase.mpp");
        ...
        (projectObj.addTask()).setName("Primera");
        (projectObj.addTask()).setID(1);
        (projectObj.getTaskByID(1)).setName("Primera");
        (projectObj.getTaskByID(1)).setUniqueID(1);
        (projectObj.getTaskByID(1)).setActive(true);
        System.out.print("Este es dato agregado:"+projectObj.getTaskByUniqueID(1).getActive());
