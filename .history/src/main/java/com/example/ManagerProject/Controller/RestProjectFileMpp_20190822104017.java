    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
        ...
        for(int i=0;i< ((JSONArray)(jsonObject.get("tareas"))).length();i++){
            try {
                ...
                (project.getTaskByID(json.getInt("id"))).set(json.getString("name"));
                ...
                project.getTaskByID(json.getInt("id")).setFinish(json.getString("id"));
                project.getTaskByID(json.getInt("id")).setActualFinish(json.getString("id"));
                project.getTaskByID(json.getInt("id")).setFinishText(json.getString("id"));
