...
public class RestProjectFileMpp {
    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException {
        ...
        System.out.println(project.getProjectConfig().getNextTaskUniqueID());
        System.out.println(project.getProjectProperties().getName());
        System.out.println(project.getProjectProperties().getActualFinish());
        System.out.println(project.getProjectProperties().getActualStart());
        System.out.println(project.getProjectProperties().getBaselineDate());
        System.out.println(project.getProjectProperties().getBaselineStart());
