...
public class RestProjectFileMpp {
    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
        ...
        if(jsonObject.getString("PFinishDate")!="null"){
            df.parse(jsonObject.getString("PFinishDate"));
            ;
           project.getProjectProperties().getFinishDate().setTime(df.parse(jsonObject.getString("PStartDate")).getTime());
           project.getProjectProperties().getFinishDate().setSeconds(df.parse(jsonObject.getString("PStartDate")).getSeconds());
           project.getProjectProperties().getFinishDate().setMinutes(df.parse(jsonObject.getString("PStartDate")).getMinutes());
           project.getProjectProperties().getFinishDate().setHours(df.parse(jsonObject.getString("PStartDate")).getHours());
           project.getProjectProperties().getFinishDate().setMonth(df.parse(jsonObject.getString("PStartDate")).getMonth());
           project.getProjectProperties().getFinishDate().setYear(df.parse(jsonObject.getString("PStartDate")).getYear());
        }
