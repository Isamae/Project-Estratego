...
public class RestProjectFileMpp {
    ...
    public String postJson(@RequestBody String payload) throws Exception{
        ...
        projectObj = addPorcentajeTareas(projectObj,jsonObject);
    ...
    public static ProjectFile addPorcentajeTareas(ProjectFile project,JSONObject jsonObject) throws JSONException{
