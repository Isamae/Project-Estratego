...
public class RestProjectFileMpp {
    ...
    public static ProjectFile addTarea(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
        ...
        project.getTaskByID(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getInt("id")).setActualStart(df.parse(((JSONArray)(jsonObject.get("tareas"))).getJSONObject(0).getString("fechaInicio")));
