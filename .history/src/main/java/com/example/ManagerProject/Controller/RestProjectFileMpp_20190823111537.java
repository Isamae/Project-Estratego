    ...
    public static ProjectFile addDuracionTareas(ProjectFile project,JSONObject jsonObject) throws JSONException{
        for(int i=0 ;i< ((JSONArray)(jsonObject.get("tareas"))).length();i++){
            try {
                ...
                System.out.println("ID :" +json.getInt("id") +"-> " + value);
                project.getTaskByID(json.getInt("id")).setDuration(value);
                project.getTaskByID(json.getInt("id")).setActualDuration(value);
                project.getTaskByID(json.getInt("id")).setActualWork(value);
                project.getTaskByID(json.getInt("id")).setBaselineDuration(value);
