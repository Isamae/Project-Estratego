        ...
        for(int i=0;i< ((JSONArray)(jsonObject.get("tareas"))).length();i++){
            try {
                ...
                if(json.getJSONArray("hijos").length() == 0){
                    ...
                    project.getTaskByID(json.getInt("id")).getStartText();
                    project.getTaskByID(json.getInt("id")).getFinishText();
                    project.getTaskByID(json.getInt("id")).getActualStart();
                    project.getTaskByID(json.getInt("id")).getActualFinish();
