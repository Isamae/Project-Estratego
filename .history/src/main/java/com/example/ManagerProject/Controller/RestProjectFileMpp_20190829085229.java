...
public class RestProjectFileMpp {
    ...
    public String postJson(@RequestBody String payload) throws Exception{
        ...
        projectObj = addAsignaionesRecursos(projectObj,jsonObject);
    ...
    public static ProjectFile addAsignaionesRecursos(ProjectFile project,JSONObject jsonObject) throws JSONException, ParseException {
