    ...
    public static ProjectFile addCamposPersonalizados(ProjectFile project,JSONObject jsonObject) throws JSONException{
        ...
        for(int i=0 ;i< ((JSONArray)(jsonObject.get("CamposPersonalizados"))).length();i++){
            try {
                ...
                if(object.getString("AliasCampo").compareToIgnoreCase("null")==1 || object.getInt("FieldTypeID")==-1){}
                else{
            ...
            try {
                ...
                for(int x = 0;  x < columnas.length(); x++){
                    ...
                    if(datoObject.getInt("FieldTypeID") == -1){}
                        ...
                        Object seteadoValue = datoObject.get("ValorCampo");
                        /*if(tipodato.compareToIgnoreCase("STRING")==1){
                           seteadoValue =  (String)datoObject.get("ValorCampo");
                        }
                        else if(tipodato.compareToIgnoreCase("PERCENTAGE")==1){
                            seteadoValue =  (Double)datoObject.get("ValorCampo");
                        }
                        else{
                            seteadoValue =  (Integer)datoObject.get("ValorCampo");
                        }*/

                        if(datoObject.getString("ValorCampo")=="null"){
                            seteadoValue = null;
                        }
                        
                        FieldType fieldType = FieldTypeHelper.getInstance(datoObject.getInt("FieldTypeID"));
