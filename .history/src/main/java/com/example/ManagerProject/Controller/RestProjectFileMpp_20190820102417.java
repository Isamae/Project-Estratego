...
public class RestProjectFileMpp {
    ...
    public String postJson(@RequestBody String payload) throws Exception{
        ...
        ProjectFile projectObj = new ProjectFile();
        JSONObject jsonObject= new JSONObject(payload);
        System.out.print("Filtr0s:" + projectObj.getFilters());
        FilterContainer fields = projectObj.getFilters();
        for(Filter filter:fields.getResourceFilters() ){
            System.out.println("Estas son las clases que se : " + filter.getName());
