...
public class Project  {
    ...
    public static String getTareas(ProjectFile project)  throws Exception{
        Iterator<CustomField> iter =  project.getCustomFields().iterator();
            while(iter.hasNext()) {
                System.out.println("Alias:"+ iter.next().getAlias());
                System.out.println("Tipo:"+ iter.next().getFieldType().getName());
                System.out.println("Tipo:"+ iter.next().getFieldType().getValue());
                System.out.println("String:" + iter.next().toString());
                System.out.println("CODE:"+   iter.next().hashCode());
            }
