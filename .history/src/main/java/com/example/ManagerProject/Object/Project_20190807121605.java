...
public class Project  {
        ...
        for (Task task : project.getAllTasks())
        {
            if(task.getName() ==null) {}
                ...
                + " }"  + " ,";
                 ...
                 "Tarea:"+ task.getUniqueID() + "Inicio:" + "Fin:"+ task.getFinish();
            }
        }
    ...
    public static String relacionesPredecesoraTareas(ProjectFile project, int  idTask) throws Exception
    {
        ...
        if (predecessors != null && predecessors.isEmpty() == false)
        {
            for (Relation relation : predecessors)
            {
                ...
                relacionPrecedecesora = relacionPrecedecesora + " { " + "taskId: " + project.getTaskByUniqueID((relation.getTargetTask()).getID()).getUniqueID() +" , " + 
                " type: " + relation.getType() + " , " + " lag: " + relation.getTargetTask().getDuration() + " } " + " ,";
            }
        }
        else{}
    ...
    public static String calendarioTarea(ProjectFile project, int  idTask) throws Exception
    {
