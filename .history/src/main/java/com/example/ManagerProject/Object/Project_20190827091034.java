...
public class Project  {
    ...
    public static String getTareas(ProjectFile project)  throws Exception{
        ...
        for(int i = 0 ; i < iter2.size(); i++){
            ...
            System.out.println("Colum:"+ iter2.get(i).getFieldType().getDataType().getValue() );
            System.out.println("Colum:"+ iter2.get(i).getFieldType().getUnitsType());
            System.out.println("Colum:"+ iter2.get(i).getTitle());
