...
public class Project  {
    ...
    public static String getTareas(ProjectFile project)  throws Exception{
        ...
        while(iter.hasNext()) {
            ...
            System.out.println("Tipo:"+ customField.getFieldType().getName());
            System.out.println("ValueT:"+ customField.getFieldType().getValue());
            System.out.println("Data Tipo:"+ customField.getFieldType().getDataType().getValue());
            System.out.println("Data Tipo:"+ customField.getFieldType()..getUnitsType());
           
        }
        List<Column> iter2 =  project.getTables().get(0).getColumns();
        for(int i = 0 ; i < iter2.size(); i++){
            System.out.println("Colum:"+ iter2.get(i).getFieldType().getName() );
            System.out.println("Colum:"+ iter2.get(i).getFieldType().getValue() );
