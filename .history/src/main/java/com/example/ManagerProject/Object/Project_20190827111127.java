...
public class Project  {
    ...
    public static String getTareas(ProjectFile project) throws Exception{
        String campospersonalidos = "[";
        List<Column> iter2 =  project.getTables().get(0).getColumns();
        
        for(int i = 0 ; i < iter2.size(); i++){
            campospersonalidos =  campospersonalidos + " { " 
            + "'FieldTypeName'" + ":" + "'" + iter2.get(i).getFieldType().getName() +"'"
            + "," + "'FieldTypeValue'" + ":" + "'" + iter2.get(i).getFieldType().getValue() +"'"
            + "," + "'FieldTypeDataTypeString'" + ":" + "'" + iter2.get(i).getFieldType().getDataType().toString() +"'"
            + "," + "'FieldTypeDataTypeValue'" + ":" + "'" + iter2.get(i).getFieldType().getDataType().getValue() +"'"
        ...
        if(campospersonalidos.length()>1){
            campospersonalidos = campospersonalidos.substring(0, campospersonalidos.length()-1) ;
        }
        else{}

        campospersonalidos = campospersonalidos + "]" ;
        return campospersonalidos ;  
    }
    ...
    public static String getTareas(ProjectFile project)  throws Exception{
        ...
        while(iter.hasNext()) {
            ...
            /*System.out.println("FAlias:"+ customField.getAlias());
            System.out.println("FTipo:"+ customField.getFieldType().getName());
            System.out.println("FValueT:"+ customField.getFieldType().getValue());
            System.out.println("FData Tipo:"+ customField.getFieldType().getDataType().toString());
            System.out.println("FData Tipo:"+ customField.getFieldType().getDataType().getValue());
            System.out.println("FData Tipo:"+ customField.getFieldType().getUnitsType());*/
        ...
        for(int i = 0 ; i < iter2.size(); i++){
            ...
            /*System.out.println("Colum Name:"+ iter2.get(i).getFieldType().getName() );
            System.out.println("Colum Value:"+ iter2.get(i).getFieldType().getValue() );
            System.out.println("Colum FDV:"+ iter2.get(i).getFieldType().getDataType().toString() );
            System.out.println("Colum FDV:"+ iter2.get(i).getFieldType().getDataType().getValue() );
            System.out.println("Colum FU:"+ iter2.get(i).getFieldType().getUnitsType());
            System.out.println("Colum Titulo:"+ iter2.get(i).getTitle());*/
